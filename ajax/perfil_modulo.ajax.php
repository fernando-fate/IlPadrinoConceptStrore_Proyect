...
if(isset($_POST['accion']) && $_POST['accion'] == 1){
  ...
  $registrarPerfilModulo = new AjaxPerfilModulo();
  $registrarPerfilModulo->ajaxRegistrarPerfilModulo($_POST['id_modulosSeleccionados'], $_POST['id_Perfil'], $_POST['idModulo_inicio']);
