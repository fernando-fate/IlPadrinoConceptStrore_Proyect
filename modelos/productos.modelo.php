...
class ProductosModelo{
    ...
    static public function mdlBuscarIdProveedor($nombreProveedor){

        $stmt = Conexion::conectar()->prepare("SELECT id_proveedor FROM proveedor WHERE nombre_proveedor = :nombreProveedor");
