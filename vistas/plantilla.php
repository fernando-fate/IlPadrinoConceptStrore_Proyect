...
<head>
    ...
    <title>Il Padrino Concept Store POS</title>

    <link rel="shortcut icon" href="vistas/assets/imagenes/padrinologo.png" type="image/x-icon">
    ...
    <link rel="stylesheet" href="/vistas/assets/dist/css/adminlte.css?v=<?php echo time(); ?>">
