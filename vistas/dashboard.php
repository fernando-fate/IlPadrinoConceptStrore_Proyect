         ...
         <div class="row">
             ...
             <div class="col-lg-2">
                 ...
                 <div class="small-box bg-success">
                     <div class="inner">
                         <h4 id="totalCompras">C$./ 2,500.00</h4>
             ...
             <div class="col-lg-2">
                 ...
                 <div class="small-box bg-warning">
                     <div class="inner">
                         <h4 id="totalVentas">C$./ 1,200.00</h4>
             ...
             <div class="col-lg-2">
                 ...
                 <div class="small-box bg-secondary">
                     <div class="inner">
                         <h4 id="totalVentasHoy">C$./ 250.00</h4>
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            $("#totalCompras").html('C$./ ' + respuesta[0]['totalCompras']);

            $("#totalVentas").html('C$./ ' + respuesta[0]['totalVentas']);
            $("#totalGanancias").html('C$./ ' + respuesta[0]['ganancias']);
            $("#totalProductosMinStock").html(respuesta[0]['productosPocoStock']);
            $("#totalVentasHoy").html('C$./ ' + respuesta[0]['ventasHoy']);
        }
    });
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            $("#title-header").html('Ventas del Mes: C$./ ' + total_ventas_mes.toString().replace(
                /\d(?=(\d{3})+\.)/g, "$&,"));
        ...
        success:function(respuesta){
            ...
            for (let i = 0; i < respuesta.length; i++) {
                filas = '<tr>'+
                            ...
                            '<td> C$ '+ respuesta[i]["total_venta"] + '</td>'+
                        '</tr>'
